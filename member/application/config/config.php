...
|
*/
$config['base_url'] = 'http://localhost/marketplace2349/member/';
$config['assets_kategori'] = $_SERVER["DOCUMENT_ROOT"]."/marketplace2349/assets/kategori/";
$config['url_kategori'] = 'http://localhost/marketplace2349/assets/kategori/';
